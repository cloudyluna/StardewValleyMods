...
\newcommand{\subProjectCompatibility}[2]{
	\subsection{Compatibility}
	If you found this mod behaving weirdly or being incompatible with other mods, please report it in the \texttt{Bug} or \texttt{Discussion}
	page on Nexusmods site so other users will be aware of such potential issues in the future.
...
\newcommand{\subProjectCompatIssues}[3]{
	\subProjectCompatibility{#1}{#2}

	\subProjectKnownIssues{#3}
}
