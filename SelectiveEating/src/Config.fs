            ...
            |> Option.iter (fun menu ->
                ...
                |> Option.iter (fun config ->
                    ...
                    menu.AddNumberOption (
                        ...
                        setValue =
                            (fun v ->
                                this.config.Value.MinimumHealthToStartAutoEat <-
                                    v
                            ),
                        name = (fun _ -> i18n "menu.basics.minimum-health"),
                        tooltip =
                            (fun _ ->
                                i18n "menu.basics.minimum-health.tooltip"
                            ),
                        min = 0,
                        max = 80,
                        interval = 10,
                    ...
                    menu.AddNumberOption (
                        ...
                        setValue =
                            (fun v ->
                                this.config.Value.MinimumStaminaToStartAutoEat <-
                                    int v
                            ),
                        name = (fun _ -> i18n "menu.basics.minimum-stamina"),
                        tooltip =
                            (fun _ ->
                                i18n "menu.basics.minimum-stamina.tooltip"
                            ),
                        min = 0,
                        max = 80,
                        interval = 10,
                    ...
                    menu.AddTextOption (
                        ...
                        setValue =
                            (fun v ->
                                this.config.Value.PriorityStrategySelection <-
                                    v
                            ),
                        name = (fun _ -> i18n "menu.basics.priority-strategy"),
                        tooltip =
                            (fun _ ->
                                i18n "menu.basics.priority-strategy.tooltip"
                            ),
                        allowedValues =
                            [|
                        ...
                        formatAllowedValue =
                            (fun unformatted ->
                                match
                                    priorityStrategyFromString unformatted
                                with
                    ...
                    menu.AddSectionTitle (
                        ...
                        text =
                            (fun _ ->
                                i18n "menu.basics.priority.subsection.title"
                            ),
                        tooltip = null
                    )
                    ...
                    menu.AddBoolOption (
                        ...
                        setValue =
                            (fun b ->
                                this.config.Value.IsSkipEatingAnimationEnabled <-
                                    b
                            ),
                        name =
                            (fun _ ->
                                i18n
                                    "menu.basics.enable-skip-eating-animation"
                            ),
                        tooltip =
                            (fun _ ->
                                i18n
                                    "menu.basics.enable-skip-eating-animation.tooltip"
                            ),
                        fieldId = null
                    )
                    ...
                    menu.AddKeybind (
                        ...
                        getValue =
                            (fun _ ->
                                config.SelectiveEatingShortcutButtonInput
                            ),
                        setValue =
                            (fun b ->
                                this.config.Value.SelectiveEatingShortcutButtonInput <-
                                    b
                            ),
                        name =
                            (fun () ->
                                i18n "menu.advanced.enable-mod-keybind"
                            ),
                        tooltip =
                            (fun () ->
                                i18n
                                    "menu.advanced.enable-mod-keybind.tooltip"
                            ),
                        fieldId = null
                    )
                    ...
                    menu.AddNumberOption (
                        ...
                        setValue =
                            (fun v ->
                                this.config.Value.ThresholdCheckPerSecond <-
                                    uint v
                            ),
                        name =
                            (fun _ ->
                                i18n "menu.advanced.check-seconds-threshold"
                            ),
                        tooltip =
                            (fun _ ->
                                i18n
                                    "menu.advanced.check-seconds-threshold.tooltip"
                            ),
                        min = 0,
                        max = 60,
                        interval = 1,
                    ...
                    menu.AddTextOption (
                        ...
                        tooltip =
                            (fun _ ->
                                i18n "menu.advanced.forbidden-food.tooltip"
                            ),
                        allowedValues = null,
                    ...
                    menu.AddParagraph (
                        ...
                        text =
                            (fun _ ->
                                i18n
                                    "menu.advanced.forbidden-food.usage-example"
                            )
                    )
                    ...
                    menu.AddBoolOption (
                        ...
                        setValue =
                            (fun b ->
                                this.config.Value.IsStayInLastDirectionEnabled <-
                                    b
                            ),
                        name =
                            (fun _ ->
                                i18n "menu.advanced.stay-in-last-direction"
                            ),
                        tooltip =
                            (fun _ ->
                                i18n
                                    "menu.advanced.stay-in-last-direction.tooltip"
                            ),
                        fieldId = null
                    )
                )
