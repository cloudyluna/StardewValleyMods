...
\changelogDoc{
    \newVersion{0.4.3}{2024-10-11}{
        \fixed{
            \item Player still eating when either health and stamina value slider is set to 0\%.
        }
    }

    \newVersion{0.4.2}{2024-09-01}{
        \changed {
            \item Default condition check interval to 1/3 second.
        }

        \fixed {
            \item A rather major performance issue whenever eating with animation is switched on.
            \item Default priority strategy selection key name not matching with the new one.
            \item Keybind toggle to turn mod on/off not saving things on toggle switch.
            \item Wonky stamina first food, priority selection.
        }
    }
